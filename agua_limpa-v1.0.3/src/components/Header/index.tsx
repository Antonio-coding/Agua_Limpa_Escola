  ...
  return (
    <>
      <header className={props.className}>
        <div className="bg-white-A700 md:h-10 h-[75px] md:px-10 sm:px-5 px-[100.23px] py-[11.14px] relative shadow-bs w-[1280px] md:w-full">
          <div className="absolute flex flex-row gap-[22.27px] h-max inset-[0] items-center justify-end m-auto w-full">
          ...
          <Img
            className="absolute h-10 inset-y-[0] left-full my-auto object-cover w-[13%]"
