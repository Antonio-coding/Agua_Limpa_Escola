                    ...
                    <div className="absolute flex md:flex-col flex-row md:gap-10 h-max inset-[0] items-start justify-between m-auto w-[97%]">
                      <div className="h-[606px] sm:h-[673px] relative w-[65%] md:w-full">
                        <div className="absolute h-[606px] sm:h-[673px] inset-[0] justify-center m-auto w-full">
                          ...
                          <Img
                            className="absolute h-[178px] left-[0] top-[7%]"
                      ...
                      <div className="h-[104px] md:mt-0 mt-[25px] relative w-1/5 md:w-full">
                        <Text
                          className="leading-[16.00px] m-auto text-2xl md:text-[22px] text-blue-800 text-center sm:text-xl"
        ...
        <div className="flex flex-col mt-10 md:px-5 relative w-full">
          <div className="bg-gray-100 flex flex-col gap-[26px] justify-end mx-auto p-[38px] sm:px-5 w-full">
            ...
            <div className="md:h-[272px] h-[289px] mx-auto relative w-[95%] md:w-full">
                ...
                <Slider
                  ...
                  items={[...Array(3)].map(() => (
                    <React.Fragment key={Math.random()}>
                      <div className="flex sm:flex-col flex-row sm:gap-10 items-start justify-between mx-2.5">
                        <Img
                          className="h-[122px] md:h-auto sm:mt-0 mt-[13px] object-cover w-[122px]"
                          src="images/img_17.png"
                          alt="Seventeen"
                        />
                        <Img
                          className="h-[108px] md:h-auto sm:mt-0 mt-[13px] object-cover"
                        ...
                        />
                        <Img
                          className="h-[130px] md:h-auto sm:mt-0 mt-[5px] object-cover w-[130px]"
                          src="images/img_45.png"
                          alt="FortyFive"
                        />
                        <Img
                          className="h-[104px] md:h-auto sm:mt-0 mt-[13px] object-cover w-[104px]"
              ...
              <Text
                className="absolute bottom-[6%] right-[26%] text-blue-800 text-center text-xs"
                size="txtInterRegular12Blue800"
              >
                <span className="text-blue-800 font-inter font-normal">
                  <>
